        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div align="right" class="mr-2">
                    {{ __('Balance: $') . number_format(auth()->user()->balance / 100, 2) }}
                    <a class="" target="_blank" href="https://www.linkedin.com/in/pedro-henrique-bruning/">+</a>
                </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                <div class="ml-3">
                    ...
                    <div class="font-medium text-sm text-gray-500">{{ __('Balance: $') . number_format(auth()->user()->balance / 100, 2) }}
                        <a class="" target="_blank" href="https://www.linkedin.com/in/pedro-henrique-bruning/">+</a>
                    </div>
